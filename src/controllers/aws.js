...
//  step2:[BEST PRACTISE]:- always write s3 upload function separately- in a separate file/function..exptect it to take file as input and return the uploaded file as output
...
let uploadFile= async ( file) =>{
   return new Promise( function(resolve, reject) {
    ...
    var uploadParams= {
        ...
        Key: "bhupendranamdev/" + file.originalname, //HERE 
        Body: file.buffer
    }
